...
# 유형 별칭 → 정규 한글 유형(제목 표기용). 영문/변형 표기를 정규화.
# (실측: 유형공백 행 끝단어 top — R/TEE 1972 · GTX 1201 · TEE 757 · SLEEVE 747 · PISTE 635 ·
#  슬립인스 775+ · MTM 463 · 런닝화 392 · 반팔티 384 · T-SHIRTS 303 · SET 395)
TYPE_ALIASES = {
    "r/tee": "티셔츠", "tee": "티셔츠", "t-shirts": "티셔츠", "t-shirt": "티셔츠",
    "반팔티": "티셔츠", "긴팔티": "티셔츠", "sleeve": "티셔츠",
    "mtm": "맨투맨", "sweatshirt": "맨투맨",
    "pants": "팬츠", "jacket": "재킷", "jersey": "저지", "hoodie": "후디", "hood": "후드",
    "piste": "피스테", "런닝화": "러닝화", "슬립인스": "슬립온", "set": "세트",
    "windbreaker": "바람막이", "vest": "베스트", "shorts": "쇼츠", "leggings": "레깅스",
    "backpack": "백팩", "cap": "캡", "hat": "햇", "socks": "양말",
}
...
# 신발류(사이즈=mm) — commerce 제목에 숫자 사이즈에 mm 단위 부여.
FOOTWEAR_TYPES = {"신발", "축구화", "러닝화", "등산화", "트레킹화", "워킹화", "트레일러닝화",
                  "테니스화", "농구화", "골프화", "스니커즈", "슬리퍼", "샌들", "부츠",
                  "클로그", "실내화", "슬립온"}
